...
#RUN in NPT		
mdCHARMM.pl -par $basicpar -par $basicpar2 -par $basicpar3 -par dynitemp=$T,dyntemp=$T,dynsteps=$stProd -log $name.prod.log -trajout $name.prod.dcd -final $name.final.pdb -restart $restartIn -restout $name.prod.restart $PDB
